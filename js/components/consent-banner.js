...
Analytics helps me understand which sections are most engaging and improve the user experience. No personal information is collected.`;
    ...
    createSettingsDialog() {
        ...
        closeIcon.innerHTML = `
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="icon" width="20" height="20" aria-hidden="true"><title>Close icon</title>
            <defs>
              <linearGradient id="i-close-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <g class="icon-gradient">
              <path d="M18 6L6 18M6 6l12 12" stroke="url(#i-close-grad)" stroke-width="2.5" pathLength="1" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
            <g class="icon-mono" style="display:none;">
              <path d="M18 6L6 18M6 6l12 12" stroke="currentColor" stroke-width="2.5" pathLength="1" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
          </svg>
        `;
